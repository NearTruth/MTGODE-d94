...
class dilated_inception(nn.Module):  # time convolution using inception modules
...
class CGPFunc(nn.Module):  # what is CGP continuous graph propagation
    ...
    def forward(self, t, x):  # graph diffusion
